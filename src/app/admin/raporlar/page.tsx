  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Raporlar & Loglar</h1>
          <p className="text-slate-500 mt-1">Sistemdeki tüm denetim verilerini dışarı aktarabilirsiniz.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-start">
          ...
          <h3 className="text-lg font-semibold text-slate-900 mb-2">Eğitim & Sınav Logları</h3>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-start">
          ...
          <h3 className="text-lg font-semibold text-slate-900 mb-2">Sisteme Giriş Logları</h3>
          <p className="text-sm text-slate-500 mb-6 flex-1">
